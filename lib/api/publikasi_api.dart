...
class PublikasiAPI {
  //Fetch All From API
  Future<List<PublikasiModel>> fetchAllPublikasi(int page) async {
    Response response = await Dio().get(
        'https://webapi.bps.go.id/v1/api/list/model/publication/domain/3274/page/$page/key/841396623eaa7ad43906a4a64c96e7a1/');
